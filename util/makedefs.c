...
do_monstr()
{
    ...
    Fprintf(ofp,Dont_Edit_Code);
    Fprintf(ofp,"/* generated by function do_monstr */\n\n");
    Fprintf(ofp,"/* this array contains difficulties of monsters, according to mstrength function */\n\n");
