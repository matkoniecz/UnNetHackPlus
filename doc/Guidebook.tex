...
%.lp
\item[\ib{autounlock}]
Automatically apply unlocking tool when trying to open a locked door or container (default true).
%.lp
\item[\ib{boulder}]
...
Implemented by the Gem and X11 ports.
Default `:'.
