General information about UnNetHackPlus
===================================

UnNetHackPlus is a fork of UnNetHack, based on UnNetHack version 4.0.0.

My plan is to add one or two things and end up with an even better game.

I will follow great design guidelines of UnNH (see below and 
https://sourceforge.net/apps/trac/unnethack/wiki/DesignGuidelines).

The project page with detailed information about changes from UnNetHack, 
source code repository and ways to reach the developer 
can be found at: https://github.com/Bulwersator/UnNetHackPlus
