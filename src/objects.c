...
PROJECTILE("elven arrow", "runed arrow",
		0, 20, 1, 2, 7, 6, 0, WOOD, -P_BOW, CLR_GREEN),
...
WEAPON("elven spear", "runed spear",
	0, 1, 0, 10, 30,  3,  7,  8, 0, P,   P_SPEAR, WOOD, CLR_GREEN),
...
WEAPON("elven dagger", "runed dagger",
	0, 1, 0, 10, 10,  4,  5,  3, 2, P,   P_DAGGER, WOOD, CLR_GREEN),
...
WEAPON("elven short sword", "runed short sword",
	0, 0, 0,  2, 30, 10,  8,  8, 0, P,   P_SHORT_SWORD, WOOD, CLR_GREEN),
...
WEAPON("elven broadsword", "runed broadsword",
	0, 0, 0,  4, 70, 10,  6,  6, 0, S,   P_BROAD_SWORD, WOOD, CLR_GREEN),
						/* +d4 small, +1 large */
...
BOW("elven bow", "runed bow",  0, 12, 30, 60, 0, WOOD, P_BOW, CLR_GREEN),
...
RING("regeneration", REGENERATION,            "moonstone", 200, 32, 1, 0, 6, MINERAL, HI_MINERAL),
...
RING("shock resistance", SHOCK_RES,              "copper", 150, 32, 1, 0, 3, COPPER, HI_COPPER),
RING("free action",     FREE_ACTION,            "twisted", 200, 32, 1, 0, 6, IRON, HI_METAL),
RING("slow digestion",  SLOW_DIGESTION,           "steel", 200, 32, 1, 0, 8, IRON, HI_METAL),
RING("teleportation", TELEPORT,                  "silver", 200, 32, 1, 0, 3, SILVER, HI_SILVER),
RING("teleport control", TELEPORT_CONTROL,         "gold", 300, 32, 1, 0, 3, GOLD, HI_GOLD),
RING("polymorph", POLYMORPH,                      "ivory", 300, 32, 1, 0, 4, BONE, CLR_WHITE),
RING("polymorph control", POLYMORPH_CONTROL,    "emerald", 300, 32, 1, 0, 8, GEMSTONE, CLR_BRIGHT_GREEN),
RING("invisibility", INVIS,                        "wire", 150, 33, 1, 0, 5, IRON, HI_METAL),
RING("see invisible", SEE_INVIS,             "engagement", 150, 32, 1, 0, 5, IRON, HI_METAL),
RING("protection from shape changers", PROT_FROM_SHAPE_CHANGERS,
                                                  "shiny", 100, 32, 1, 0, 5, IRON, CLR_BRIGHT_CYAN),
...
AMULET("amulet of change",            "square",     0,/* POLYMORPH */  130),
...
/* other tools */
TOOL("expensive camera", (char *)0,  1, 0, 0, 1,  15, 12, 200, PLASTIC, CLR_BLACK),
...
TOOL("can of grease", (char *)0,     1, 0, 0, 1,  15, 15,  20, IRON,    CLR_BRIGHT_GREEN),
...
WEPTOOL("pick-axe", (char *)0,         1, 0, 0, 20, 100,  50,  6,  3, WHACK,  P_PICK_AXE, IRON, HI_METAL),
WEPTOOL("grappling hook", "iron hook", 0, 0, 0,  5,  30,  50,  2,  6, WHACK,  P_FLAIL, IRON, HI_METAL),
/* 3.4.1: unicorn horn left classified as "magic" */
WEPTOOL("unicorn horn", (char *)0,     1, 1, 1,  0,  20, 100, 12, 12, PIERCE, P_UNICORN_HORN, BONE, CLR_WHITE),
...
WAND((char *)0,        "black",     0, 150, 1, 0,         IRON,     CLR_BLACK),
