...
{	{"Rogue", 0}, {
	...
	MH_HUMAN|MH_ORC|MH_ELF|MH_GNOME|MH_DWARF|MH_VAMPIRE | ROLE_MALE|ROLE_FEMALE |
	  ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{   7,  7,  7, 10,  7,  6 },
	{  20, 10, 10, 30, 20, 10 },
...
{	{"Ranger", 0}, {
	...
	MH_HUMAN|MH_ELF|MH_GNOME|MH_DWARF|MH_ORC | ROLE_MALE|ROLE_FEMALE |
	  ROLE_NEUTRAL|ROLE_CHAOTIC,
	/* Str Int Wis Dex Con Cha */
	{  13, 13, 13,  9, 13,  7 },
	{  30, 10, 10, 20, 20, 10 },
...
{	"dwarf", "dwarven", "dwarvenkind", "Dwa",
	...
	MH_DWARF | ROLE_MALE|ROLE_FEMALE | ROLE_LAWFUL|ROLE_CHAOTIC,
