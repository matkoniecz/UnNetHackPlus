...
/*
 * LINE OF SIGHT Algorithm use the following macros.
 *
 *      good_row(z)	  - Return TRUE if the argument is a legal row.
 *      set_cs(rowp,col)  - Set the local could see array.
 *      set_min(z)	  - Save the min value of the argument and the current row minimum.
 *      set_max(z)	  - Save the max value of the argument and the current row maximum.
 *
 ...
 */
STATIC_DCL int FDECL(q1_path, (int,int,int,int));
STATIC_DCL int FDECL(q2_path, (int,int,int,int));
STATIC_DCL int FDECL(q3_path, (int,int,int,int));
STATIC_DCL int FDECL(q4_path, (int,int,int,int));
...
/*
 * Defines local to LINE OF SIGHT Algorithm.
 */
